...
안녕하세요!👋 1년차 웹 개발자 **정혜선**입니다.  
주로 Java, Spring을 사용해서 백엔드 개발을 하고 있습니다.

**Projects**
- (주)아시아나IDT | 아시아나항공 항공홈페이지 Cash&Miles 적용 프로젝트 참여

**Experience**
- 2025.01 ~ 재직중 (주)케파스 - SI

**교육**
- 2024.07 ~ 2024.11 SSAFY 12기 이수
- 2023.01 ~ 2023.11 코드스쿼드 백엔드 마스터즈 MAX 수료
- 2017.03 ~ 2023.02 명지대 산업경영공학과(주전공)/응용소프트웨어전공(복수전공) 졸업  
